...
function anexGrid_link(config) {
    ...
    config.attr = atributos;
//cambio de la etiqueta <a> atributo href cambiado por onclick
    return '<a id="' + config.id + '" style="' + config.style + '" href="' + config.href + '" target="' + config.target + '" class="' + config.class + '" ' + config.attr + '>' + config.contenido + '</a>';
}
...
function anexGrid_input(config) {
    config = {
        ...
        style: config.style !== undefined ? config.style : '',
        attr: config.attr !== undefined ? config.attr : [],
        id: config.id !== undefined ? config.id : '', //se agrego id
        name: config.name !== undefined ? config.name : '', //se agrego name
    ...
    return '<input name="' + config.name + '" id="' + config.id + '" type="' + config.type + '" style="' + config.style + '" class="form-control input-sm ' + config.class + '" value="' + config.value + '" ' + config.attr + ' />';
}
